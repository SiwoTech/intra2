    ...
    async function fetchFranchises() {
        try {
            ...
            if (json.success) {
                ...
                currentUserInfo = userInfo; // Guardar información del usuario globalmente
    ...
    function isCurrentUserAdmin() {
        ...
        return tipo && tipo.toLowerCase() === 'admin';
    }
...
function enterFranchise(clave, ful) {
        window.location.href = `selorden.html?a=${franq}&b=${user}&c=${nivel}&d=${tipo}&e=${clave}&f=${ful}`;
